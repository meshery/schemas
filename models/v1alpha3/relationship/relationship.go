...
//
// Code generated by github.com/oapi-codegen/oapi-codegen/v2 version v2.3.0 DO NOTEDIT.
...
type RelationshipDefinition struct {
	...
	Metadata *Relationship_Metadata `json:"metadata,omitempty" yaml:"metadata"`
...
type RelationshipDefinitionMetadataStyles struct {
	...
	CurveStyle *RelationshipDefinitionMetadataStylesCurveStyle `json:"curve-style,omitempty"`
	...
	LineCap *RelationshipDefinitionMetadataStylesLineCap `json:"line-cap,omitempty"`
	...
	LineStyle *RelationshipDefinitionMetadataStylesLineStyle `json:"line-style,omitempty"`
	...
	MidTargetArrowFill *RelationshipDefinitionMetadataStylesMidTargetArrowFill `json:"mid-target-arrow-fill,omitempty"`

	// MidTargetArrowShape The shape of the edge’s source arrow
	MidTargetArrowShape *RelationshipDefinitionMetadataStylesMidTargetArrowShape `json:"mid-target-arrow-shape,omitempty"`
	...
	TargetArrowShape *RelationshipDefinitionMetadataStylesTargetArrowShape `json:"target-arrow-shape,omitempty"`
	...
	TextTransform *RelationshipDefinitionMetadataStylesTextTransform `json:"text-transform,omitempty"`
...
type RelationshipDefinition_Selectors_Patch struct {
	...
	PatchStrategy *RelationshipDefinitionSelectorsPatchStrategy `json:"patchStrategy,omitempty"`
