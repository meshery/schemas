...
type AcademyCurricula struct {
	...
	BadgeId *core.Uuid `db:"badge_id" json:"badgeId" yaml:"badgeId"`

	// CreatedAt When the Curricula item was created
	CreatedAt AcademyCurriculaCreatedAt `db:"created_at" json:"createdAt" yaml:"createdAt"`
	DeletedAt AcademyCurriculaDeletedAt `db:"deleted_at" json:"deletedAt" yaml:"deletedAt"`
	...
	InviteId *AcademyCurriculaInviteId `db:"invite_id" json:"inviteId" yaml:"inviteId"`
	...
	UpdatedAt  AcademyCurriculaUpdatedAt `db:"updated_at" json:"updatedAt" yaml:"updatedAt"`
	...
	WorkspaceId *AcademyCurriculaWorkspaceId `db:"workspace_id" json:"workspaceId" yaml:"workspaceId"`
}

// AcademyCurriculaAccessExpiresAt Expiry time for curricula access
type AcademyCurriculaAccessExpiresAt = *time.Time

// AcademyCurriculaCreatedAt defines model for AcademyCurriculaCreatedAt.
type AcademyCurriculaCreatedAt = core.Time

// AcademyCurriculaDeletedAt defines model for AcademyCurriculaDeletedAt.
type AcademyCurriculaDeletedAt = core.NullTime
...
// AcademyCurriculaUpdatedAt When the Curricula was last updated
...
type AcademyRegistration struct {
	...
	ContentId openapi_types.UUID `db:"content_id" json:"contentId" yaml:"contentId"`
...
type CreateAcademyCurriculaRequest struct {
	...
	AccessStatus invitationv1beta3.InvitationStatus `db:"access_status" json:"accessStatus" yaml:"accessStatus"`
...
type SingleAcademyCurriculaResponse struct {
	...
	Invitation *invitationv1beta3.Invitation `json:"invitation,omitempty" yaml:"invitation,omitempty"`
...
type TestSubmission struct {
	...
	TestAbsPath string `db:"test_abs_path" json:"testAbsPath" yaml:"testAbsPath"`
...
type UserRegistration struct {
	...
	CurriculaPermalink string `db:"curricula_permalink" json:"curriculaPermalink" yaml:"curriculaPermalink"`

	// CurriculaTitle Title of the curricula
	CurriculaTitle string      `db:"curricula_title" json:"curriculaTitle" yaml:"curriculaTitle"`
	CurriculaType  ContentType `db:"curricula_type" json:"curriculaType" yaml:"curriculaType"`

	// RegistrationId Unique ID of the registration
	RegistrationId openapi_types.UUID `db:"registration_id" json:"registrationId" yaml:"registrationId"`

	// Status Status of the user's course registration
	Status AcademyRegistrationStatus `db:"status" json:"status" yaml:"status"`

	// TotalCount Total count for pagination
	TotalCount int64 `db:"total_count" json:"totalCount" yaml:"totalCount"`

	// UserAvatarUrl Avatar URL of the user
	UserAvatarUrl string `db:"user_avatar_url" json:"userAvatarUrl" yaml:"userAvatarUrl"`

	// UserEmail Email of the user
	UserEmail openapi_types.Email `db:"user_email" json:"userEmail" yaml:"userEmail"`

	// UserFirstName First name of the user
	UserFirstName string `db:"user_first_name" json:"userFirstName" yaml:"userFirstName"`

	// UserId ID of the user
	UserId openapi_types.UUID `db:"user_id" json:"userId" yaml:"userId"`

	// UserLastName Last name of the user
	UserLastName string `db:"user_last_name" json:"userLastName" yaml:"userLastName"`
}
