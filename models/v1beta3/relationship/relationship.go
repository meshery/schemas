...
type RelationshipDefinition struct {
	...
	ModelId core.Uuid `gorm:"index:idx_relationship_definition_dbs_model_id,column:model_id" json:"-" yaml:"-"`
...
type SelectorItem struct {
	...
	// RelationshipDefinitionSelectorsPatch Patch configuration for the selector
	RelationshipDefinitionSelectorsPatch *RelationshipDefinitionSelectorsPatch `json:"patch" yaml:"patch"`
}
