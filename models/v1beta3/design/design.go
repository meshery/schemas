...
// Valid indicates whether the value is a known member of the MesheryPatternDesignType enum.
func (e MesheryPatternDesignType) Valid() bool {
	switch e {
	case MesheryPatternDesignTypeDesign:
		return true
	case MesheryPatternDesignTypeDockerCompose:
		return true
	case MesheryPatternDesignTypeHelmChart:
		return true
	case MesheryPatternDesignTypeKubernetesManifest:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the MesheryPatternVisibility enum.
func (e MesheryPatternVisibility) Valid() bool {
	switch e {
	case MesheryPatternVisibilityPrivate:
		return true
	case MesheryPatternVisibilityPublic:
		return true
	case MesheryPatternVisibilityPublished:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the MesheryPatternImportFormPayloadUploadType enum.
func (e MesheryPatternImportFormPayloadUploadType) Valid() bool {
	switch e {
	case FileUpload:
		return true
	case URLImport:
...
// Valid indicates whether the value is a known member of the MesheryPatternPayloadDesignType enum.
func (e MesheryPatternPayloadDesignType) Valid() bool {
	switch e {
	case MesheryPatternPayloadDesignTypeDesign:
		return true
	case MesheryPatternPayloadDesignTypeDockerCompose:
		return true
	case MesheryPatternPayloadDesignTypeHelmChart:
		return true
	case MesheryPatternPayloadDesignTypeKubernetesManifest:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the MesheryPatternPayloadVisibility enum.
func (e MesheryPatternPayloadVisibility) Valid() bool {
	switch e {
	case MesheryPatternPayloadVisibilityPrivate:
		return true
	case MesheryPatternPayloadVisibilityPublic:
		return true
	case MesheryPatternPayloadVisibilityPublished:
		return true
	default:
		return false
	}
...
type MesheryPattern struct {
	...
	DesignType *MesheryPatternDesignType `db:"source_type" json:"designType,omitempty" yaml:"designType,omitempty"`
...
type MesheryPatternPayload struct {
	...
	DesignType *MesheryPatternPayloadDesignType `json:"designType,omitempty" yaml:"designType,omitempty"`
	ID         core.Id                  `json:"id,omitempty" yaml:"id,omitempty"`
	Location   core.MapObject           `json:"location,omitempty" yaml:"location,omitempty"`
