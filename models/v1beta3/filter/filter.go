...
// Valid indicates whether the value is a known member of the MesheryFilterImportFormPayloadUploadType enum.
func (e MesheryFilterImportFormPayloadUploadType) Valid() bool {
	switch e {
	case FileUpload:
		return true
	case URLUpload:
