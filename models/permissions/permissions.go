...
var (
	...
	CatalogManagementWasmFilterAndFilter = PermissionKey(uuid.MustParse("9225d5a7-7255-49be-9233-daeabefae306"))
	...
	GitopsGithub = PermissionKey(uuid.MustParse("9f236c99-b2ec-4474-9ec8-7c3f8a09e63e"))

	// GitopsGitlab - Initiate deployment with creation of pull request
	GitopsGitlab = PermissionKey(uuid.MustParse("9f236c99-b2ec-4474-9ec8-7c3f8a09e63e"))

	// GitopsArgoevents - Initiate deployment with creation of pull request
	GitopsArgoevents = PermissionKey(uuid.MustParse("81287ea7-5e3f-480c-8b2e-211d62d08797"))
	...
	KanvasResizeComponents = PermissionKey(uuid.MustParse("faa0cb66-af78-4a6f-84f0-3bfae7254276"))
	...
	KanvasViewInteractiveTerminal = PermissionKey(uuid.MustParse("4726da45-2108-409b-b94f-45bd1e199a78"))
	...
	PerformanceManagementMesheryAdapterForNighthawk = PermissionKey(uuid.MustParse("72066352-d09b-494a-b02e-846676bd7a0a"))

	// PerformanceManagementDistributedTests - Allow users to identity Kubernetes clusters
	PerformanceManagementDistributedTests = PermissionKey(uuid.MustParse("72066352-d09b-494a-b02e-846676bd7a0a"))
	...
	AcademyAComprehensiveGuideToUsingTheInstructorConsoleLearnHowToTrackLearnerProgressAnalyzeTestPerformanceAndManageYourAcademySContentAndMetrics = PermissionKey(uuid.MustParse("045fad17-d2cc-46e8-bb10-f9ee026c799f"))
	...
	ConfigurationManagementVirtualservice = PermissionKey(uuid.MustParse("9a84a5d0-0a16-11ee-be56-0242ac120002"))
