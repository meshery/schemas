...
type User struct {
	AcceptedTermsAt core.Time `db:"accepted_terms_at" json:"accepted_terms_at" yaml:"accepted_terms_at"`
	...
	FirstLoginTime core.Time   `db:"first_login_time" json:"first_login_time" yaml:"first_login_time"`
