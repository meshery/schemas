...
type CancelSubscriptionRequest struct {
	...
	PaymentProcessor *CancelSubscriptionRequestPaymentProcessor `json:"payment_processor,omitempty"`
...
type CreateSubscriptionRequest struct {
	...
	// PaymentProcessor Supported payment processors
	PaymentProcessor *CreateSubscriptionRequestPaymentProcessor `json:"payment_processor,omitempty"`
...
type Subscription struct {
	...
	BillingId string       `db:"billing_id" json:"billing_id"`
...
type UpdateUsersRequest struct {
	// PaymentProcessor Supported payment processors
	PaymentProcessor *UpdateUsersRequestPaymentProcessor `json:"payment_processor,omitempty"`
}
...
type UpgradeSubscriptionRequest struct {
	...
	OldPlanId *uuid.UUID `json:"old_plan_id,omitempty"`
}
