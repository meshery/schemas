...
type ComponentDefinition struct {
	...
	Model model.ModelDefinition `gorm:"foreignKey:ModelId;references:Id" json:"model"`
	...
	// ModelId ModelId is the foreign key to the model to which the component belongs.
