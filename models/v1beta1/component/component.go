...
type Styles struct {
	...
	BodyTextFontSize *string `json:"body-text-font-size,omitempty"`
	...
	BodyTextWeight *string `json:"body-text-weight,omitempty"`
...
type ComponentDefinition struct {
	...
	Metadata ComponentDefinition_Metadata `gorm:"type:bytes;serializer:json" json:"metadata,omitempty"`
