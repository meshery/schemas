...
type EnvironmentConnectionMapping struct {
	...
	ConnectionId core.Uuid `db:"connection_id" json:"connection_id" yaml:"connection_id"`
	...
	EnvironmentId core.Uuid      `db:"environment_id" json:"environment_id" yaml:"environment_id"`
