...
type AcademyCirriculaListResponse struct {
	Data []AcademyCirricula `json:"data"`
...
type AcademyRegistration struct {
	...
	Certificate core.Map `db:"certificate" json:"certificate"`
	...
	// DeletedAt Timestamp when the resource was deleted.
	DeletedAt core.NullTime `db:"deleted_at" json:"deleted_at,omitempty"`
	...
	Status AcademyRegistrationStatus `db:"status" json:"status"`
...
type AcademyRegistrationsListResponse struct {
	Data []AcademyRegistration `json:"data"`
...
type Certificate struct {
	...
	IssuingAuthorities []CertificateIssuingAuthority `json:"issuing_authorities"`
...
type CirriculaProgressTracker struct {
	Completed core.NullTime `json:"completed"`

	// CompletedItems Items that have been completed (map of item IDs to item data)
	CompletedItems map[string]ProgressItemCompleted    `json:"completed_items"`
	CurrentItem    map[string]CirriculaCurrentItemData `json:"current_item"`
	Grades         map[string]QuizEvaluationResult     `json:"grades"`
...
type ProgressItemCompleted struct {
	...
	ItemData    Parent    `json:"item_data"`
}
...
type Question struct {
	...
	MultipleAnswers *bool            `json:"multiple_answers,omitempty"`
...
type Quiz struct {
	...
	NextPage    Parent `json:"next_page"`
	...
	Permalink      string     `json:"permalink"`
	Prerequisites  []Parent   `json:"prerequisites"`
...
type QuizEvaluationResult struct {
	...
	CorrectSubmissions map[string]bool `json:"correct_submissions"`
	PassPercentage     float32         `json:"pass_percentage"`
	Passed             bool            `json:"passed"`
	PercentageScored   float32         `json:"percentage_scored"`
	Quiz               Quiz            `json:"quiz"`
...
type QuizSubmission struct {
	...
	QuizAbsPath    string            `json:"quiz_abs_path"`
...
type RegisterToAcademyContentRequest struct {
	...
	ContentType *RegisterToAcademyContentRequestContentType `json:"content_type,omitempty"`
}
...
type StartTestRequest struct {
	RegistrationId string `json:"registration_id"`
	TestAbsPath    string `json:"test_abs_path"`
}
...
type SubmittedAnswer struct {
	...
	SelectedOptionId map[string]bool `json:"selected_option_id"`
}
...
type TestSubmission struct {
	...
	Result         *QuizEvaluationResult `db:"result" json:"result,omitempty"`
	Status         TestSubmissionStatus  `json:"status"`
	SubmissionData *QuizSubmission       `db:"submission_data" json:"submission_data,omitempty"`
	SubmittedAt    *time.Time            `db:"submitted_at" json:"submitted_at,omitempty"`
	Test           Quiz                  `json:"test"`
	TestAbsPath    string                `db:"test_abs_path" json:"test_abs_path"`
...
type UpdateCurrentItemRequest struct {
	ContentType ContentType              `json:"content_type"`
	ItemData    CirriculaCurrentItemData `json:"item_data"`
}
...
type UserRegistration struct {
	...
	CurriculaPermalink string `db:"curricula_permalink" json:"curricula_permalink"`

	// CurriculaTitle Title of the curricula
	CurriculaTitle string `db:"curricula_title" json:"curricula_title"`

	// CurriculaType Type of the curricula
	CurriculaType ContentType `db:"curricula_type" json:"curricula_type"`

	// RegistrationId Unique ID of the registration
	RegistrationId openapi_types.UUID `db:"registration_id" json:"registration_id"`
	...
	UserEmail openapi_types.Email `db:"user_email" json:"user_email"`

	// UserFirstName First name of the user
	UserFirstName string `db:"user_first_name" json:"user_first_name"`

	// UserId ID of the user
	UserId openapi_types.UUID `db:"user_id" json:"user_id"`
