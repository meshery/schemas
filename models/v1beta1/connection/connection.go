...
type Connection struct {
	...
	UserID       *uuid.UUID                 `db:"user_id" json:"user_id,omitempty" yaml:"user_id"`
	...
	Environments []*environment.Environment `db:"-" gorm:"-" json:"environments,omitempty" yaml:"environments"`
