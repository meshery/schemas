...
func (m *ModelDefinition) ReplaceSVGData(baseDir string) error {
	// Metadata is *ModelDefinition_Metadata on v1beta2; nil-guard before
	// dereferencing (the v1beta1 helper this is ported from would panic on
	// nil — a latent bug flagged for follow-up).
	if m.Metadata == nil {
		return nil
	}
