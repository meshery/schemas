...
func (e ImportRequestUploadType) Valid() bool {
	switch e {
	case ImportRequestUploadTypeCsv:
		return true
	case ImportRequestUploadTypeFile:
		return true
	case ImportRequestUploadTypeUrl:
		return true
	case ImportRequestUploadTypeUrlImport:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the MesheryModelImportFormPayloadUploadType enum.
func (e MesheryModelImportFormPayloadUploadType) Valid() bool {
	switch e {
	case MesheryModelImportFormPayloadUploadTypeCsv:
		return true
	case MesheryModelImportFormPayloadUploadTypeFile:
		return true
	case MesheryModelImportFormPayloadUploadTypeUrlImport:
		return true
	default:
		return false
	}
