...
const DesignSchema: Record<string, unknown> = {
  "openapi": "3.0.0",
  "info": {
    "title": "Design",
          ...
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "type": "array",
                  "description": "Designs persisted by the import, in the order they were saved. Always a single element on this path.",
                  "minItems": 1,
                  "items": {
                    "type": "object",
                    "description": "Server-returned design (pattern) resource as persisted by meshery-cloud.",
                ...
                "schema": {
                  ...
                  "properties": {
                    ...
                    "contentType": {
                      ...
                      "x-enum-varnames": [
                        "CatalogContentTypePattern",
                        "CatalogContentTypeFilter"
                      ]
                    },
                    "contentClass": {
                      "type": "string",
                      ...
                      "x-enum-varnames": [
                        ...
                        "CatalogContentClassVerified",
                        "CatalogContentClassProject",
                        "CatalogContentClassCommunity"
                      ],
                      "x-oapi-codegen-extra-tags": {
                        "db": "content_class"
                      }
                    ...
                    "status": {
                      ...
                      "x-go-type": "CatalogRequestStatus",
                      "type": "string",
                      "enum": [
                        "pending",
                        "approved",
                      ...
                      "x-enum-varnames": [
                        "CatalogRequestStatusPending",
                        "CatalogRequestStatusApproved",
                        "CatalogRequestStatusDenied"
                      ]
                    },
                    "createdAt": {
