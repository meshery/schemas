...
const MeshsyncSchema: Record<string, unknown> = {
  "openapi": "3.0.0",
  "info": {
    "title": "MeshSync",
    "description": "OpenAPI schema for Meshery's MeshSync resources API. This API is used for fetching and managing Kubernetes resources discovered by MeshSync.",
    "version": "v1beta1",
    "contact": {
  ...
  "tags": [
    {
      "name": "MeshSync",
      "description": "Operations on MeshSync resources."
    }
  ],
  "paths": {
    "/api/system/meshsync/resources": {
      "get": {
        ...
        "operationId": "getMeshSyncResources",
        "summary": "List MeshSync resources",
        "description": "Returns a paginated list of Kubernetes resources discovered by MeshSync. When `asDesign` is true the resources are converted to a Meshery design and relationship-evaluated before being returned.",
        "parameters": [
          {
            "name": "page",
            "in": "query",
          ...
          },
          {
            "name": "kind",
            "in": "query",
            "description": "Filter by Kubernetes resource kind. Accepts multiple values (repeated query param).",
            "required": false,
            "schema": {
              "type": "array",
              "items": {
          ...
          },
          {
            "name": "model",
            "in": "query",
            "description": "Filter by model name. Accepts multiple values (repeated query param).",
            "required": false,
            "schema": {
              "type": "array",
              "items": {
          ...
          },
          {
            "name": "namespace",
            "in": "query",
            "description": "Filter by namespace. Accepts multiple values (repeated query param).",
            "required": false,
            "schema": {
              "type": "array",
              "items": {
          ...
          },
          {
            "name": "clusterId",
            "in": "query",
            "description": "Cluster IDs to scope the query. Accepts multiple values (repeated query param).",
            "required": false,
            "schema": {
              "type": "array",
              "items": {
          ...
          },
          {
            "name": "label",
            "in": "query",
            "description": "Filter by label key-value pair. Accepts multiple values (repeated query param).",
            "required": false,
            "schema": {
              "type": "array",
              "items": {
          ...
          },
          {
            "name": "labels",
            "in": "query",
            "description": "When `true`, embeds the full label map on each returned resource.",
            "required": false,
            "schema": {
              "type": "boolean"
            }
          },
          {
            "name": "status",
            "in": "query",
            "description": "When `true`, embeds the status sub-resource on each returned resource.",
            "required": false,
            "schema": {
              "type": "boolean"
            }
          },
          {
            "name": "annotations",
            "in": "query",
            "description": "When `true`, embeds the full annotation map on each returned resource.",
            "required": false,
            "schema": {
              "type": "boolean"
            }
          },
          {
            "name": "spec",
            "in": "query",
            "description": "When `true`, embeds the spec sub-resource on each returned resource.",
            "required": false,
            "schema": {
              "type": "boolean"
            }
          },
          {
            "name": "apiVersion",
            "in": "query",
            "description": "Filter by Kubernetes API version (e.g. `apps/v1`).",
            "required": false,
            "schema": {
              "type": "string",
              "maxLength": 255
          ...
          },
          {
            "name": "asDesign",
            "in": "query",
            "description": "When `true`, converts the matched resources into a Meshery design, evaluates relationships, and returns the design in the `design` field instead of `resources`.",
            "required": false,
            "schema": {
              "type": "boolean"
            }
          },
          {
            "name": "patternId",
            "in": "query",
            "description": "Filter resources by the Meshery pattern (design) ID. Accepts multiple values (repeated query param).",
            "required": false,
            "schema": {
              "type": "array",
              "items": {
        ...
        "responses": {
          "200": {
            "description": "Paginated list of MeshSync resources.",
            "content": {
              "application/json": {
                "schema": {
                  "description": "A paginated list of MeshSync-discovered Kubernetes resources.",
                  "type": "object",
                  ...
                  "properties": {
                    ...
                    "resources": {
                      "type": "array",
                      "description": "The discovered Kubernetes resources. Empty when `asDesign` is true.",
                      "items": {
                        "type": "object"
                      }
                    },
                    "design": {
                      "description": "Present (and `resources` is empty) when `asDesign=true`. Contains the relationship-evaluated Meshery design built from the matched resources.",
    ...
    "/api/system/meshsync/resources/summary": {
      "get": {
        ...
        "operationId": "getMeshSyncResourceKinds",
        "summary": "Get MeshSync resource kinds summary",
        "description": "Returns a summary of discovered resource kinds (with per-kind counts), distinct namespaces, and distinct labels for the requested clusters.",
        "parameters": [
          {
            "name": "clusterId",
            "in": "query",
            "description": "Cluster IDs to scope the summary. Accepts multiple values (repeated query param). At least one value is required.",
            "required": true,
            "schema": {
              "type": "array",
              "items": {
          ...
          },
          {
            "name": "namespace",
            "in": "query",
            "description": "Restrict the summary to the given namespaces. Accepts multiple values (repeated query param).",
            "required": false,
            "schema": {
              "type": "array",
              "items": {
          ...
          },
          {
            "name": "patternId",
            "in": "query",
            "description": "Restrict the summary to resources belonging to the given Meshery pattern IDs. Accepts multiple values (repeated query param).",
            "required": false,
            "schema": {
              "type": "array",
              "items": {
        ...
        "responses": {
          "200": {
            "description": "MeshSync resource kinds summary.",
            "content": {
              "application/json": {
                "schema": {
                  "description": "Summary of discovered MeshSync resources for the requested clusters.",
                  "type": "object",
                  "additionalProperties": false,
                  "properties": {
                    "kinds": {
                      "type": "array",
                      "description": "Per-kind resource counts.",
                      "items": {
                        "description": "Per-kind resource count for a given model.",
                        "type": "object",
                        "additionalProperties": false,
                        "properties": {
                          "kind": {
                          ...
                          "model": {
                            "type": "string",
                            "description": "Meshery model name that registered this kind.",
                            "maxLength": 255
                          },
                          "count": {
                            "type": "integer",
                            "format": "int64",
                            "description": "Number of discovered resources of this kind.",
                            "minimum": 0
                          }
                        }
                      }
                    ...
                    "namespaces": {
                      "type": "array",
                      "description": "Distinct namespaces containing discovered resources.",
                      "items": {
                        "type": "string",
                        "maxLength": 255
                      }
                    ...
                    "labels": {
                      "type": "array",
                      "description": "Distinct label key-value pairs found on discovered resources.",
                      "items": {
                        "description": "A discovered Kubernetes key-value pair (e.g. a label).",
                        "type": "object",
                        "additionalProperties": false,
                        "properties": {
                          "id": {
                            "type": "string",
                            "description": "MeshSync resource ID associated with this key-value pair.",
                            "maxLength": 255
                          },
                          "uniqueId": {
                            "type": "string",
                            "description": "Internal unique identifier for this key-value pair.",
                            "maxLength": 255
                          },
                          "kind": {
                            "type": "string",
                            "description": "Key-value kind, such as `label` or `annotation`.",
                            "maxLength": 255
                          },
                          "key": {
                            "type": "string",
          ...
          "400": {
            "description": "Bad request - `clusterId` is required but was not provided."
          },
          "401": {
            "description": "Expired JWT token used or insufficient privilege",
            "content": {
    ...
    "/api/system/meshsync/resources/{resourceId}": {
      "get": {
        "x-internal": [
          "meshery"
        ],
        ...
        "operationId": "getMeshSyncResourceById",
        "summary": "Get a MeshSync resource by ID",
        "description": "Returns a single MeshSync-discovered Kubernetes resource by its ID, including its full spec, status, labels, and annotations. The resource is converted and returned as a Meshery component definition.",
        "parameters": [
          {
            "name": "resourceId",
            "in": "path",
        ...
        "responses": {
          "200": {
            "description": "The MeshSync resource represented as a component definition.",
            "content": {
              "application/json": {
                "schema": {
                  "$id": "https://schemas.meshery.io/component.yaml",
      ...
      "delete": {
        ...
        "operationId": "deleteMeshSyncResource",
        "summary": "Delete a MeshSync resource",
        "description": "Deletes a specific MeshSync-discovered resource by ID.",
        "parameters": [
          {
            "name": "resourceId",
            "in": "path",
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "description": "Response returned after deleting a MeshSync resource.",
                  "type": "object",
                  "additionalProperties": false,
                  "properties": {
                    "deleted": {
                      "type": "boolean",
                      "description": "Whether the MeshSync resource was deleted."
                    }
                  }
                }
              }
