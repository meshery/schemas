...
export interface DesignSchema {
  ...
  version: string;
  /**
   * Map of component instances to their corresponding component declarations
   */
  components: {
    /**
    ...
    /**
     * Component and it's configuration.
     */
    component: {
      /**
  ...
  relationships: {
    /**
     * ID (UUID) of the source component
     */
    from: string;
    /**
     * ID (UUID) of the target component
     */
    to: string;
    /**
    ...
    type: string;
    /**
     * Subtype of the relationship (optional)
     */
    subType?: string;
    /**
     * Status of the relationship
     */
    status: "evaluating" | "valid" | "invalid";
    [k: string]: unknown;
  }[];
  [k: string]: unknown;
}
