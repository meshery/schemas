...
const schema = {
  ...
  "properties": {
    ...
    "version": {
      "$ref": "../../v1alpha1/core/openapi.yml#/components/schemas/semverString",
      "x-order": 3,
    ...
    "displayName": {
      "$ref": "../../v1alpha1/core/openapi.yml#/components/schemas/inputString",
      "x-order": 4,
    ...
    "modelReference": {
      "$ref": "../model/openapi.yml#/components/schemas/ModelReference",
