...
For comprehensive documentation on contributing to Meshery schemas, see [Contributing to Schemas](https://docs.meshery.io/project/contributing/contributing-schemas).
...
Please do! We're a warm and welcoming community of open source contributors.

- [General Contributor Guide](https://docs.meshery.io/project/contributing) - Overview of contribution processes
- [Schema Contributor Guide](./CONTRIBUTING.md) - Schema directory structure, naming conventions, code generation, and development workflows
- [Contributing to Models](https://docs.meshery.io/project/contributing/contributing-models) - Meshery's model terminology and concepts
